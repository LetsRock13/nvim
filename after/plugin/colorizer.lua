require("colorizer").setup({
  ...
  options = {
    ...
    display = {
      mode = {"background", "virtualtext"}, -- string or list: "background"|"foreground"|"underline"|"virtualtext"
      background = {
        bright_fg = "#333333", -- text color on bright backgrounds
        dark_fg = "#dddddd", -- text color on dark backgrounds
      },
      virtualtext = {
